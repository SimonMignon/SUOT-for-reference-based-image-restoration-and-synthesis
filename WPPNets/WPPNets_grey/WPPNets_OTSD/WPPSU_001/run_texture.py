...
def WLoss(args, input_img, ref_pat, model, psi):
    ...
    semidual_loss = utils.semidual(ref_pat,ρ=ρ,usekeops=keops)
    ...
    optim_psi = torch.optim.ASGD([semidual_loss.psi], lr=0.1, alpha=0.5, t0=1)
...
if __name__ == '__main__':
    ...
    image_classes = ['floor','grass','tile','tile1','wood','wood1']
    image_class = image_classes[5] #choose the texture
    ...
    if retrain:
        ...
        if image_class == 'floor':
            ...
            epochs = 270
            args.n_iter_psi=20
        elif image_class == 'tile':
            args.center = True
            epochs = 270
        elif image_class == 'tile1':
            args.center = True
            epochs = 270
            args.n_iter_psi=20
